...
const contractAddress = "0x33a1022f159Af8c4a344529BF12fc071325aFCcf"; // Replace with the contract address
...
function generateChartVinoImbottigliato() {
    // Call the queryDataUvaRaccolta function of the smart contract
    contract.methods.queryQuantitaVinoImbottigliataPerLotto().call()
      .then(function(result) {
        const resultQuantita = result[0];
        const resultLotti = result[1];
