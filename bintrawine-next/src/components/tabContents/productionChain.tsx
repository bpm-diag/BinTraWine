                ...
                actorItemData: [
                    ...
                    },
                    {
                        ...
                        data: [
                            {
                                name: "Superficie",
                                value: getLotto.data.viticoltore.agronomoData?.superficieTerreno + "mq" ?? "Dato non trovato"
                            },
                            {
                                name: "Umidità",
                                value: getLotto.data.viticoltore.agronomoData?.umiditaTerreno + "%" ?? "Dato non trovato"
                            },
                            {
                                name: "Temperatura",
                                value: getLotto.data.viticoltore.agronomoData?.temperaturaTerreno + "°" ?? "Dato non trovato"
                            },
                            {
                                name: "Pioggia",
                                value: getLotto.data.viticoltore.agronomoData?.pioggiaTerreno + "mm" ?? "Dato non trovato"
                            },
                        ]
                    }
                ],
                ...
                actorItemData: [
                    ...
                    },
                    {
                        ...
                        data: [
                            {
                                name: "Codice a barre",
                                value: getLotto.data.distributore?.imbottigliatoreData?.codiceABarre ?? "Dato non trovato"
                            }
                        ]
                    }
                ]
